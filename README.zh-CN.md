...
- Agent 运行架构、接口、工具、MCP、memory、审批、plan、skill：[`docs/agent-runtime-architecture.zh-CN.md`](docs/agent-runtime-architecture.zh-CN.md)；英文版：[`docs/agent-runtime-architecture.md`](docs/agent-runtime-architecture.md)
